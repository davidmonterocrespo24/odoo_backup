...
odoo.define("odoo_backup_sh.dashboard", function (require) {
    ...
    var Dashboard = AbstractAction.extend({
        ...
        events: {
            ...
            "click .o_dashboard_action_backup_config":
                "o_dashboard_action_backup_config",
            "click .o_dashboard_action_view_backups": "o_dashboard_action_view_backups",
            "click .o_backup_dashboard_notification .close":
            ...
            return self
                ...
                .then(function (results) {
                    ...
                    self.services_storage_usage_graph_values =
                        results.services_storage_usage_graph_values;
        ...
        render_backup_config_cards: function () {
            ...
            _.each($o_backup_dashboard_configs.find(".o_kanban_record"), function (
                ...
                self.render_backup_config_card_graph(
                    record.dataset.db_name,
                    record.dataset.service
                );
            });
        },
